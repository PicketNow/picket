...
async function seed() {
  ...
  await user1.addEvent(event4)
  await user1.addEvent(event15)
  await user1.addEvent(event9)
  await user1.addEvent(event3)
  await user1.addEvent(event14)
  await user1.addEvent(event8)
  await user1.addEvent(event2)
  await user1.addEvent(event13)
  await user1.addEvent(event7)
  await user1.addEvent(event1)
  await user1.addEvent(event12)
  await user1.addEvent(event6)
  await user1.addEvent(event11)
  await user1.addEvent(event5)
